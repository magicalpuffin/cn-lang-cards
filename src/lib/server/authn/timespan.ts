// https://github.com/pilcrowonpaper/oslo/blob/main/src/index.ts

export type TimeSpanUnit = "ms" | "s" | "m" | "h" | "d" | "w";

export function isBeforeExpirationDate(date: Date): boolean {
	return Date.now() < date.getTime();
}

export function createExpirationDate(timeSpan: TimeSpan): Date {
